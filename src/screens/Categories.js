  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={styles.pieChartContainer}>
        <Text style={styles.pieChartHeader}>Expense Breakdown</Text>
        ...
        <Animated.View style={styles.createCategoryContainer}>
          ...
          <Modal
            ...
            <View
              ...
              <Text style={styles.subMenuText}>Enter New Category</Text>
              <TextInput
                style={styles.input}
              ...
              <Text style={styles.subMenuText}>Select Parent Category</Text>
              <Picker
