...
const BudgetConfig = ({route, navigation}) => {
  ...
  return (
    <Animated.View style={styles.container}>
      <Text style={styles.BudgetHeaderText}>Budget Setup</Text>
      ...
      <Animated.View style={styles.ContentContainer}>
        ...
        <Animated.View style={styles.RemainingUnallocatedContainer}>
          ...
          <Animated.Text style={styles.RemainingUnallocatedAmountText}>
            {(
              budget -
              (diningValue + firstValue + transitValue + otherValue)
            ).toFixed(2)}
          </Animated.Text>
        </Animated.View>
      </Animated.View>
      ...
      <Animated.View>
        <TouchableOpacity
          onPress={async () => {
            console.log(firstValue, transitValue, diningValue, otherValue);
