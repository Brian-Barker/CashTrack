  ...
  return (
    <View style={styles.container}>
      <Animated.View style={styles.addPurchaseContainer}>
        <Text style={styles.addPurchaseHeader}>Add A Purchase</Text>
        <Text style={styles.addPurchaseSubHeader}>Company Name</Text>
        <TextInput
          style={styles.input}
        ...
        <Text style={styles.addPurchaseSubHeader}>Category</Text>
        <Picker
        ...
        <Text style={styles.addPurchaseSubHeader}>Purchase Amount</Text>
        <TextInput
          style={styles.input}
